...
<!-- Paste this banner at the top of every cochranblock GitHub repo README -->
...
>
> Every repo ships with **Proof of Artifacts** (wire diagrams, screenshots, and build output proving the work is real) and a **Timeline of Invention** (dated commit-level record of what was built, when, and why — proving human-piloted AI development, not generated spaghetti).
>
