...
<div id="profile" class="tab-pane active" role="tabpanel" aria-hidden="false">
  ...
  <p>Michael Cochran — Fractional CTO, Zero-Cloud Architect, Army veteran (17C Cyber Operations). 11+ years defense and enterprise. SDVOSB pending. It's not the Mech — it's the pilot.</p>
