...
<article class="product-card"><span class="product-badge">In Development</span><h2><a href="https://github.com/cochranblock/pixel-forge" rel="noopener noreferrer">Pixel Forge</a></h2><p>AI pixel art generator. Three on-device models (Cinder/Quench/Anvil) — generate, judge, and arrange 16&times;16 sprites into game scenes. Free on App Store + Google Play. No cloud. 4.2 MB base model.</p></article>
</div>
