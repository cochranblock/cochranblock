...
pub async fn f2(State(_p0): State<Arc<t0>>) -> Html<String> {
    let v0 = r#"<section class="hero"><p class="hero-status">Product in development · Consulting: limited capacity</p><div class="hero-logo"><a href="/products"><img src="/assets/cochranblock-hero-logo.svg?v=6" alt="" class="hero-logo-img" width="128" height="128"></a></div><h1>CochranBlock</h1><p class="tagline">Rust-only SaaS that goes after the big guys — and their greed.</p><p class="hero-stats">Offline-first · Creative mode · Superior pricing · AI-powered software reset</p><p class="hero-note">Leveraging AI to reset the software market globally. Old-school offline options. No lock-in. No bloat.</p><p class="hero-skills">Rust · Zero bloat · Offline-first · Creative mode · AI orchestration · Enterprise-grade security</p><p class="hero-cta"><a href="/services" class="btn">What We Build</a><a href="/book" class="btn btn-secondary">Book a Call</a><a href="/contact" class="btn btn-secondary">Get in Touch</a><a href="/about" class="btn btn-secondary">About CochranBlock</a></p></section>"#;
