...
curl -s -X POST "https://api.indexnow.org/IndexNow" \
  ...
  -d '{"host":"cochranblock.org","key":"cochranblock-indexnow-key","keyLocation":"https://cochranblock.org/cochranblock-indexnow-key.txt","urlList":["https://cochranblock.org/","https://cochranblock.org/services","https://cochranblock.org/deploy","https://cochranblock.org/book","https://cochranblock.org/mathskillz","https://cochranblock.org/codeskillz","https://cochranblock.org/products","https://cochranblock.org/about","https://cochranblock.org/contact","https://cochranblock.org/sbir","https://cochranblock.org/downloads","https://cochranblock.org/community-grant","https://cochranblock.org/openbooks","https://cochranblock.org/analytics","https://cochranblock.org/speed","https://cochranblock.org/tinybinaries","https://cochranblock.org/govdocs","https://cochranblock.org/vre","https://cochranblock.org/source","https://cochranblock.org/search"]}' \
